...
const resetNom = () =>{
  ...
  champreqNom.classList.add("d-none")
...
const resetPrenom = () =>{
  ...
  champreqPrenom.classList.add("d-none")
...
return false;
  ...
  const resetRole = () =>{
    ...
    champreqRole.classList.add("d-none")
  ...
  submit.addEventListener("click",(e) => {
    console.log("clicked");
  if(( !checknom()&& !checkprenom() &&  !checkroles()  && !checkEmail()  && !checkmdp1() &&  !checkmdp2()  ) || !checknom() || !checkprenom()  || !checkEmail() || !checkroles() || !checkmdp1() || !checkmdp2() ){
    e.preventDefault(); 
  }
